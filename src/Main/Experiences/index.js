...
import { Title, Slider, SeeAll, SliderArrow } from '../styled';
  ...
  <Experiences>
    ...
    <Slider>
      <div className="col-xs-6 col-md-4 col-lg-3">
        <Card link="/" image={img1} price="$29" title="Forest therapy" reviews="44 reviews" />
      </div>

      <div className="col-xs-6 col-md-4 col-lg-3">
        <Card link="/" image={img2} price="$69" title="Whale watching" reviews="46 reviews" />
      </div>
      ...
      <div className="col-xs-6 col-md-4 col-lg-3">
        <Card link="/" image={img4} price="$50" title="Salsa Night" reviews="44 reviews" />
      </div>
    </Slider>
    <Arrow />
  </Experiences>
